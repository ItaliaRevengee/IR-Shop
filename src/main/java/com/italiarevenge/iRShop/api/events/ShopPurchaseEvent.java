...
/**
 * Fired before a player completes a purchase.
 * Cancelling this event prevents the transaction and shows no message;
 * set a custom reason via {@link #setCancelReason(String)} to send one.
 */
